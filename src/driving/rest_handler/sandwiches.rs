    ...
    result
        ...
        .map_err(|e| match e {
            ...
            UpdateError::NotFound => ApiError::NotFound(String::from(
                "No sandwich to update corresponding to the specified criteria",
            )),
...
mod tests {
    ...
    use actix_web::{test, App, FromRequest, Handler, Responder, Route};

    use crate::tests::test_utils::shared::{
        assert_on_ingredients, stub_cheeseburger_ingredients, stub_ingredients, stub_sandwich,
        CHEESEBURGER_NAME, SANDWICH_ID, SANDWICH_NAME, SANDWICH_TYPE,
    };
